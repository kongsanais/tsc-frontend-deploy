<template>
    ...
    <v-card class="mb-2" color="primary" dark >
      <v-row >
        <v-col class="d-flex" xl="12" lg="12" md="12" sm="12" cols="12">
          <img  src="https://www.flaticon.com/svg/static/icons/svg/2942/2942397.svg" class="ma-1" width="50px" height="50px"  alt="">
          <h2 class="ma-2">
            User  [ Engineer & Manegement ]          
          </h2>
          <v-spacer></v-spacer>
          <v-spacer></v-spacer>
        </v-col>
    ...
    <v-card class="mt-5 mb-5">
      <v-row class="pa-3">
        ...
        <v-col xl="2" lg="4" md="4" sm="12" cols="12">
          <StockCard
            title="All Applicant"
            avatar_ic="https://www.flaticon.com/svg/static/icons/svg/1402/1402118.svg"
            avatar_bg="#3F51B5"
        ...
        <v-col  xl="2" lg="4" md="4" sm="12" cols="12">
          <StockCard
            title="Waitting"
            avatar_ic="https://www.flaticon.com/svg/static/icons/svg/3706/3706593.svg"
        ...
        <v-col  xl="2" lg="4" md="4" sm="12" cols="12">
          <StockCard
            title="HR Consider"
            avatar_ic="https://www.flaticon.com/svg/static/icons/svg/2452/2452852.svg"
          ...
          <StockCard
            title="Interview"
            avatar_ic="https://www.flaticon.com/svg/static/icons/svg/850/850155.svg"
          ...
          <StockCard
            title="Hiring"
            avatar_ic="https://www.flaticon.com/svg/static/icons/svg/1412/1412222.svg"
          ...
          <StockCard
            title="Fail"
            avatar_ic="https://www.flaticon.com/svg/static/icons/svg/1413/1413862.svg"
  ...
  <v-col xl="6" lg="6" md="6" sm="12" cols="12">
    <v-card class="mb-2">
        <!-- <v-btn class="success mt-2 ml-2" @click="fillData()"><v-icon>mdi-refresh</v-icon></v-btn> -->
         <v-row>
           <v-col xl="6" lg="6" md="6" sm="12" cols="12"><v-card class="ma-1"><h3>Chart Data Applicant Status</h3></v-card></v-col>
        </v-row>
  ...
  <v-card class="mb-2">
      <!-- <v-btn class="success mt-2 ml-2" @click="fillData()"><v-icon>mdi-refresh</v-icon></v-btn> -->
         <v-row>
           <v-col xl="6" lg="6" md="6" sm="12" cols="12"><v-card class="ma-1"><h3>Chart Data Applicant Register in 2020</h3></v-card></v-col>
        </v-row>
  ...
  data() {
    return {
      ...
      field_data_export:[
        ...
        {filed: 'th_prefix',  name: 'TH_prefix'},
        {filed: 'th_fullname',  name: 'TH_fullname'},
        {filed: 'eng_prefix',  name: 'ENG_prefix'},
        {filed: 'eng_fullname',  name: 'ENG_fullname'},
        {filed: 'phone_number',  name: 'Phone Number'},
        {filed: 'phone_famaily',  name: 'Phone Famaily'},
        {filed: 'address',  name: 'Address'},
        ...
        {filed: 'degree_education', name: 'Education Name'},
        {filed: 'education', name: 'Degree Education'},
        {filed: 'majoy_education', name: 'Major'},
        {filed: 'gpa', name: 'GPA'},
        {filed: 'score_quiz', name: 'Quiz Score'},
   ...
   methods: {
     async loadApplicant(){
        ...
        this.statusArray = await api.getReportStatusEngineer()
     ...
     async fillData () {
      ...
      async filterDataTable() {
        ...
        let result = await api.getAllApplicantByDate_Engineer({ date_start, date_end });
        this.mDataArray = result;
      },
      async getDataExport(){
        let field = this.field_selected
        let date_filter = this.export_filter
        let data =  await api.getJSON_Export_Engineer({field,date_filter});
